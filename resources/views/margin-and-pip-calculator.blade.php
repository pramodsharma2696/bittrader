                    ...
                    <div class="service-details__item">
                        <div class="service-details__item-inner ">
                            ...
                            <div class="service-details__content" data-aos="fade-up" data-aos-duration="900">
                                ...
                                <p class="mb-3">See how much a single point of movement is worth – as well as how much margin you'll need to trade – with this pip calculator for forex and all our available markets.</p>
                    ...
                    <div class="service-details__item">
                        <div class="service-details__item-inner ">
                            ...
                            <div class="service-details__content" data-aos="fade-up" data-aos-duration="900">
                                ...
                                <p class="mb-3">In most forex pairs, one pip is equal to a single-digit move in the fourth decimal place (0.0001) of the pair’s price. So it’s equivalent to 1/100 of 1%. If EUR/USD moves from 1.1732 to 1.1737, for example, it has gone up five pips.</p>
                                ...
                                <p class="mb-3">In addition to the standard pip, most forex brokers also offer ‘fractional pip pricing’ by adding an extra fifth decimal place to their quotes. As well as enabling tighter spreads, these can give you a better understanding of a currency price’s movements.</p>
