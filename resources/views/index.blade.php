  ...
  <div class="container">
    <div class="service__wrapper">
      <div class="row g-4 align-items-center">
        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" style="margin-left: 27px;">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="pills-forex-tab" data-bs-toggle="pill" data-bs-target="#pills-forex" type="button" role="tab" aria-controls="pills-forex" aria-selected="true">Forex</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-metals-tab" data-bs-toggle="pill" data-bs-target="#pills-metals" type="button" role="tab" aria-controls="pills-metals" aria-selected="false">Metals</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-indices-tab" data-bs-toggle="pill" data-bs-target="#pills-indices" type="button" role="tab" aria-controls="pills-indices" aria-selected="false">Indices</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-crypto-tab" data-bs-toggle="pill" data-bs-target="#pills-crypto" type="button" role="tab" aria-controls="pills-crypto" aria-selected="false">Crypto Pairs</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-commodities-tab" data-bs-toggle="pill" data-bs-target="#pills-commodities" type="button" role="tab" aria-controls="pills-commodities" aria-selected="false">Commodities</button>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="pills-forex" role="tabpanel" aria-labelledby="pills-forex-tab">
                    ...
                    <div class="tradingview-widget-container">
                        ...
                        <div class="tradingview-widget-copyright">
                            <a href="https://in.tradingview.com/markets/currencies/forex-cross-rates/?utm_source=orbitglobalfx.com&utm_medium=widget_new&utm_campaign=forex-cross-rates" rel="noopener" target="_blank">
                                <span class="blue-text">Exchange Rates</span>
                            </a> by TradingView
                        </div>
                    </div>
                ...
                <div class="tab-pane fade" id="pills-metals" role="tabpanel" aria-labelledby="pills-metals-tab">
                    ...
                    <div class="tradingview-widget-container">
                        ...
                        <div class="tradingview-widget-copyright">
                            <a href="https://in.tradingview.com/?utm_source=orbitglobalfx.com&utm_medium=widget_new&utm_campaign=symbol-overview" rel="noopener nofollow" target="_blank">
